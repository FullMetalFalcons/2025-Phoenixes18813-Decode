// Copyright Alben Beena 2026 - Version 2.10 - MIRRORED FOR RED
...
@Autonomous(name = "Red Auto Near V5", group = "!auto")
public class RedAutoNearV2 extends LinearOpMode {
    ...
    static final double BASE_SHOOTER_POWER = 0.525;
    ...
    static final double FRONT_CHAMBER_YAW_OFFSET = Math.toRadians(-3);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStarted() && !isStopRequested()) {
            detectDecodeOrder();
            telemetry.addData("Status", "Ready - Red Near");
        ...
        TrajectorySequence cycle1 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                ...
                .addTemporalMarker(0.3, () -> intake.setPower(INTAKE_POWER))
                ...
                .lineToLinearHeading(new Pose2d(-6, 6, Math.toRadians(218)))
                .build();
        ...
        TrajectorySequence cycle2 = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(34.5, 11, Math.toRadians(90)))
                .addTemporalMarker(0.3, () -> intake.setPower(INTAKE_POWER))
                .lineToConstantHeading(new Vector2d(34.5, 65))
                .waitSeconds(0.0)
                .addTemporalMarker(() -> intake.setPower(0))
                .addTemporalMarker(() -> setShooterPower(currentShooterPower))
                .lineToLinearHeading(new Pose2d(-6, 6, Math.toRadians(220)))
                .build();
        ...
        TrajectorySequence returnToPosition = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(17, 17, Math.toRadians(218)))
                .build();
        drive.followTrajectorySequence(returnToPosition);

        limelight.stop();

        telemetry.addData("Status", "Complete! - Red Near");
        telemetry.update();
    }
    ...
    LLResultTypes.FiducialResult getGoalTag() {
        return getTagById(24);  // RED SIDE tag
    }
