// Copyright Alben Beena 2026 - Version 2.10
...
public class BlueAutoFar extends LinearOpMode {
    ...
    // ========== KEY POSES (matched to MeepMeep) ==========
    static final Pose2d   START_POSE = new Pose2d(60, -15, Math.toRadians(-90));
    static final Vector2d SHOOT_POS  = new Vector2d(57, -15);
    static final Vector2d INTAKE_TOP    = new Vector2d(27, -23);
    static final Vector2d INTAKE_BOTTOM = new Vector2d(27, -71);

    // ========== SHOOTING HEADINGS ==========
    static final double CYCLE_0_SHOOT_TURN    = 20;   // Turn amount in degrees added to start heading (-90°), so 30 = -60°
    static final double CYCLE_1_SHOOT_HEADING = -55;  // Absolute heading in degrees for second shoot
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!isStarted() && !isStopRequested()) {
            detectDecodeOrder();
            telemetry.addData("Status", "Ready - Blue Far");
        ...
        TrajectorySequence cycle1shoot = drive.trajectorySequenceBuilder(drive.getPoseEstimate())
                .lineToLinearHeading(new Pose2d(SHOOT_POS.getX(), SHOOT_POS.getY(), Math.toRadians(CYCLE_1_SHOOT_HEADING)))  // Turn to second shooting heading
        ...
        telemetry.addData("Status", "Complete! - Blue Far");
        telemetry.update();
    }
